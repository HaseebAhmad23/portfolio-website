...
export default function About() {
  return (
    <section id="about" className="border-t border-zinc-800/50 px-6 py-20">
      ...
      I also have experience integrating AI-driven features, such as personalized chatbots, into real-world applications, with a focus 
      on usability, scalability, and practical impact. I enjoy working on challenging problems, taking ownership of features end-to-end, 
      and contributing to systems that deliver measurable value to users and businesses.
        </p>
        <div className="mt-8">
